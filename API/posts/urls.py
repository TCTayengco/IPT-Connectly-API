...
from . import views
from .views import UserListCreate, PostListCreate, CommentListCreate, RegisterUser, LoginUser, UserListCreate, PostLike, PostComment, PostCommentsList, PostDetail, GoogleLoginView, LogoutUser, UserRoleUpdate, UserDelete
...
urlpatterns = [
    ...
    path('users/<int:pk>/role/', UserRoleUpdate.as_view(), name='user-role-update'),
